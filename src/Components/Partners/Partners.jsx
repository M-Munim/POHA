  ...
  return (
    <div className=''>
      <div className='partners' id='partners'>
        <div className="flex items-center justify-center py-20 border gap-3">
      ...
      <div className="mt-96 relative z-0 ">
        ...
        {/* <img src={svgBackground} alt="" className='bg-red-300 top-0' /> */}
      ...
      <div className="mt-40 w-11/12 m-auto flex justify-between">
        <div className="left border w-2/5 z-10">
          ...
          <div className="inputs flex flex-col items-center justify-center gap-3 mt-14">
            ...
            <div className="input">
              <input type="tel" name="" id="" placeholder='Contact Number' className='w-96 h-10 rounded border border-textLight py-2 ps-2 font-normal text-base outline-none' />
            </div>
